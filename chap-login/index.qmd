...
![](img/login-movil.jpg){fig-align="center" width="300"}

## Inicio de sesión

Para el acceso, se debe presionar en el botón que indica "Sign in with Google"[^1].

![](img/sign-in-msg.png){fig-align="center"}
...
![](img/sign-in-popup.jpg){fig-align="center" width="300"}
...
![](img/board-empty.png){fig-align="center"}
